...
export class QuizStateService { 
  ...
  currentQuestionSubject = new BehaviorSubject<QuizQuestion | undefined>(undefined);
  currentQuestion$: Observable<QuizQuestion | undefined> = this.currentQuestionSubject.asObservable();
