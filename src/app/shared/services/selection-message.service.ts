...
export class SelectionMessageService {
  ...
  public emitFromClick(params: {  
    ...
    // ─────────────────────────────────────────────────────────────
    // Handle multiple-answer logic dynamically
    if (questionType === QuestionType.MultipleAnswer) {
      ...
      // Calculate how many options are correct and selected
      ...
      // If all correct options are selected, show the "next" button message
      if (selectedCorrectCount === totalCorrectAnswers) {
        ...
        // If some but not all correct options are selected, show the "select more" message
        this.updateSelectionMessage("Select 1 more correct answer to continue...", { options, index, questionType, token: tok });
      } else {
        // If no correct options are selected, show the "select option" message
    ...
    // ─────────────────────────────────────────────────────────────
    // Handle other question types (e.g., SingleAnswer)
    const msg = "Select 1 more correct answer to continue...";
