...
export class SharedOptionComponent implements OnInit, OnChanges {
  ...
  generateFeedbackForOptions(correctOptions: Option[], optionsToDisplay: Option[]): string {
    // Check if correctOptions array is valid
    ...
    if (!correctMessage) {
      console.warn('Correct message could not be generated by setCorrectMessage.');
