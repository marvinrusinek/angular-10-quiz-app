...
export class QuizQuestionComponent extends BaseQuestionComponent
  ...
  /* private restoreQuizState(): void {
    ...
    // Set displayExplanation using the one-time lock
    this.displayExplanationLock(this.isAnswered);
    console.log(`Restored state - displayExplanationLocked: ${this.displayExplanationLocked}`);
  ...
  /* private restoreQuizState(): void {
    ...
    // Set the display directly based on answer state and lock it
    if (this.isAnswered) {
        this.showExplanationText();
        console.log(`Locked display to explanation for answered question`);
    } else {
        this.showQuestionText();
  ...
  /* private restoreQuizState(): void {
    ...
    if (storedDisplayExplanation) {
        this.showExplanationText();
        console.log(`Restored: explanation text for answered question`);
    } else {
        this.showQuestionText();
  ...
  /* private restoreQuizState(): void {
    ...
    this.currentQuestionIndex = storedIndex ? +storedIndex : this.currentQuestionIndex;
    this.isAnswered = storedIsAnswered;
    this.displayMode = storedDisplayMode; // Type-safe assignment with default to "question"

    // Display based on the locked displayMode
    if (this.displayMode === "explanation") {
        this.showExplanationText();
        console.log(`Restored explanation display for question ${this.currentQuestionIndex}`);
    } else {
  ...
  private displayExplanationLock(isAnswered: boolean): void {
      if (!this.displayExplanationLocked) {
          this.displayExplanation = isAnswered;
          this.displayExplanationLocked = true;  // Permanently lock displayExplanation
          this.applyLockedDisplay();  // Render content once based on the locked state
      }
  }
