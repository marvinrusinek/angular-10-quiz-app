  ...
  implements OnInit, OnChanges, OnDestroy, AfterViewInit
{
  ...
  public async applyOptionFeedbackToAllOptions(): Promise<void> {
    ...
    try {
        ...
        const currentQuestionId = this.currentQuestion.quizId ?? 'UNKNOWN';
        console.log(`[applyOptionFeedbackToAllOptions] Handling Question ID: ${currentQuestionId}`);
        ...
        // ✅ Pass `questionId` to generateFeedbackForOptions
        const feedbackMessage = this.feedbackService.generateFeedbackForOptions(localCorrectOptions, [...localOptionsToDisplay], currentQuestionId);
